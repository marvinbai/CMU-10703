...
class HistoryStore:
    ...
    def flat(self,nn_input):
        output=np.zeros((84*2,84*2))
        output[0:84,0:84]=nn_input[:,:,0]
        output[0:84,84:168]=nn_input[:,:,1]
        output[84:168,0:84]=nn_input[:,:,2]
        output[84:168,84:168]=nn_input[:,:,3]
        return output
