...
class LinearDecayGreedyEpsilonPolicy(Policy):
    ...
    def __init__(self, start_value, end_value, end_step):  
        self.start_value = start_value
        self.end_value = end_value
        self.end_step = end_step
        self.progress = 0
        self.slope = (self.start_value - self.end_value) / self.end_step
    ...
    def select_action(self,  q_values, **kwargs):
        ...
        epsilon_curr = self.start_value - self.slope * self.progress
        self.progress = self.progress + 1
        if epsilon_curr < self.end_value:
            epsilon_curr = self.end_value
